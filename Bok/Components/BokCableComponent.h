...
#include "BokCableComponent.generated.h"

class FBokPrimitiveSceneProxy;

/** Struct containing information about a point along the cable */
struct FBokCableParticle
{
	FBokCableParticle()
	: bFree(true)
	, Position(0,0,0)
...
class BOK_API UBokCableComponent : public UMeshComponent
{
...
private:
	...
	TArray<FBokCableParticle>	Particles;


	friend class FBokCableSceneProxy;
};
